...
export default function OnboardingPage() {
  ...
  const handleCreateExperience = async (e: React.FormEvent) => {
    ...
    if (!name.trim()) return toast.info("El nombre de la productora es obligatorio.")
    if (!description.trim()) return toast.info("La descripción es obligatoria.")
    if (!logoFile) return toast.info("Debes subir un Logo para tu productora.")
