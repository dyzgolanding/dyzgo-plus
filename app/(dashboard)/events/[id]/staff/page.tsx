...
export default function StaffPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleAddValidator = async () => {
    if (!newValidatorData.name || !newValidatorData.code) return toast.info("Completa todos los campos")
    if (newValidatorData.code.length !== 6) return toast.info("El código debe tener 6 dígitos")
